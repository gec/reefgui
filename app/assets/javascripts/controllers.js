    ...
    function processValue( info, measurement) {
        ...
        switch (info.type) {
            ...
            case "Capacity":
                ...
                console.log( "measurement " + measurement.name + " capacity " + value)
                break;
            case "Charging":
                value = formatNumberValue( value) + " " + info.unit;
                break;
